...
def plot_fires_vs_vpd(df: pd.DataFrame):
    ...
    # x range for plotting the power law curve (based on summer VPD only)
    ...
    # power law fit curve (black) – fitted only on summer points
    ax.plot(
        vpd_fit,
        fires_fit,
        color="black",
    ...
    out_path = BASE_DIR / "2_vpd_max_studies/only_s_s_fires_vs_vpd_max_scatter_power_law.png"
