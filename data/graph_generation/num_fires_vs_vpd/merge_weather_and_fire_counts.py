...
def merge_weather_and_fire(year: int):
    ...
    # If any fire_count missing (should not happen, but safe) → 0
    ...
    out_file = OUTPUT_DIR / f"daily_weather_fire_{year}.csv"
...
def main():
    print("=" * 80)
    print("🔗 Merging daily weather (with VPD) and wildfire counts per year")
    print("=" * 80)
